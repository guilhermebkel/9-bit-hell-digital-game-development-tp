...
void GameplayScene::Update(float deltaTime)
{
    ...
    if (!mMusicPlayed && GetGame()->GetSceneState() == Game::SceneState::Running)
    {
        ...
        switch (mLevelID)
        {
            case LevelID::Tutorial:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/gameplay-m1-stage5-synapse-retrogenesis.ogg"));
                break;
            case LevelID::Level1:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_1_c2_misplaced_in_time.mp3"));
                break;
            case LevelID::Level2:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_2_d5_the_way_ahead_feels_lonely.mp3"));
                break;
            case LevelID::Level3:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_3_e2_and_heart_breaks.mp3"));
                break;
            case LevelID::Level4:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_4_e6_sublime_beyond_loss.mp3"));
                break;
            case LevelID::Level5:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_5_f7_libet_delay.mp3"));
                break;
            case LevelID::Level6:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_6_g1_stage_4_post_awareness_confusions.mp3"));
                break;
            case LevelID::Level7:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_7_l1_stage_5_advanced_plaque_entanglements.mp3"));
                break;
            case LevelID::Level8:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_8_o1_stage_6_a_confusion_so_thick_you_forget_forgetting.mp3"));
                break;
            case LevelID::Level9:
                GetGame()->GetAudioSystem()->PlayMusic(Game::ResolvePath("Assets/Sounds/level_9_q1_stage_6_long_decline_is_over.mp3"));
                break;
        }
    }
    ...
    if (isGameOver)
    {
        ...
        {
            GetGame()->GetAudioSystem()->PlaySound(Game::ResolvePath("Assets/Sounds/game-over-by-corruption.ogg"));
        }
    }
}
...
void GameplayScene::LoadTutorial()
{
    ...
    new Background(GetGame(), Game::ResolvePath("Assets/Levels/BackgroundGameTutorial.png"));
